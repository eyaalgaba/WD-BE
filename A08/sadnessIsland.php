...
$getquery = "SELECT name,color FROM `islandsofpersonality` WHERE islandOfPersonalityID = '5';";
...
$imagequery ="SELECT image, color, content FROM islandcontents WHERE islandOfPersonalityID = '5';";
...
<body>
  ...
  <div class="w3-content" style="max-width:1500px">
      ...
      <div class="w3-padding-32">
        ...
        <div class="w3-bar w3-border">
          ...
          <a href="hobbiesIsland.php" class="w3-bar-item w3-button w3-hover-green">Hobbies
            Island</a>
          <a href="friendsIsland.php" class="w3-bar-item w3-button w3-hover-purple">Friends
            Island</a>
          <a href="#" class="w3-bar-item w3-button w3-hover-blue" style="color:<?php echo $colorarr[2] ?>;">Sadness
            Island</a>
        </div>
    ...
    <!-- Photo Grid -->
    <div class="w3-row-padding w3-grayscale-min" style="margin-bottom:128px">

      <div class="w3-half">
        <img src="imgs/<?php echo $imagearr[0] ?>.png" style="width:100%; border-radius: 20px; border-color: <?php echo $imagecolorarr[1] ?>; border-style: groove;">
        <img src="imgs/<?php echo $imagearr[2] ?>.png" style="width:100%; border-radius: 20px; border-color: <?php echo $imagecolorarr[1] ?>; border-style: groove;">
      </div>

      <div class="w3-half">
        <img src="imgs/<?php echo $imagearr[1] ?>.png" style="width:100%; border-radius: 20px; border-color: <?php echo $imagecolorarr[1] ?>; border-style: groove;">

        <div class="w3-cell">
          <h1 class="bear"
            style="color: <?php echo $imagecolorarr[3] ?>; font-weight: bold; font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; text-align: center;">
            <?php echo $contentrarr[0] ?></h1>

          <p Class="sad"><?php echo $contentrarr[1] ?></p>
