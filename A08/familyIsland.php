...
$getquery = "SELECT name,color FROM `islandsofpersonality` WHERE islandOfPersonalityID = '2';";
...
$imagequery ="SELECT image, color, content FROM islandcontents WHERE islandOfPersonalityID = '2';";
...
<head>
  ...
  <style>
    ...
    .family {
      color: white;
      background-color: <?php echo $imagecolorarr[2] ?>;
      border-style: solid;
      border-radius: 20px;
      text-align: center;
...
<body>
  ...
  <div class="w3-content" style="max-width:1500px">
    ...
    <header class="w3-panel w3-center" style="padding:128px 16px">
      ...
      <div class="w3-padding-32">
        <div class="w3-bar w3-border">
          ...
          <a href="#" class="w3-bar-item w3-button w3-hover-pink" style="color:<?php echo $colorarr[2] ?>">Family Island</a>
    ...
    <div class="w3-row-padding w3-grayscale-min" style="margin-bottom:128px">
      ...
      <div class="w3-half">
        <img src="imgs/<?php echo $imagearr[0] ?>.png" style="width:100%; border-radius: 20px; border-color: <?php echo $imagecolorarr[0] ?>; border-style: groove;">
        ...
        <div class="w3-cell">
          ...
          <p Class="family">
          <?php echo $contentrarr[1] ?><br></br>

          <?php echo $contentrarr[2] ?><br></br>

          <?php echo $contentrarr[3] ?><br></br>

          <?php echo $contentrarr[4] ?></br>
          </p>
        </div>
      ...
      <div class="w3-half">
        <img src="imgs/<?php echo $imagearr[1] ?>.png"
          style="width:100%; border-radius: 20px; border-color: <?php echo $imagecolorarr[0] ?>; border-style: groove;">
