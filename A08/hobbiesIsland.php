...
$getquery = "SELECT name,color FROM `islandsofpersonality` WHERE islandOfPersonalityID = '3';";
...
$imagequery ="SELECT image, color, content FROM islandcontents WHERE islandOfPersonalityID = '3';";
  ...
  <div class="w3-content" style="max-width:1500px">
      ...
      <div class="w3-padding-32">
        ...
        <div class="w3-bar w3-border">
          ...
          <a href="familyIsland.php" class="w3-bar-item w3-button w3-hover-pink">Family
            Island</a>
          <a href="#" class="w3-bar-item w3-button w3-hover-green" style="color:<?php echo $colorarr[2] ?>;">Hobbies Island</a>
    ...
    <div class="w3-row-padding w3-grayscale-min" style="margin-bottom:90px">
      ...
      <div class="w3-half">
        <h1 class="hobby3"
          style="color: <?php echo $imagecolorarr[1] ?>; font-weight: bold; font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; text-align: center;">
          <?php echo $contentrarr[2] ?></h1>
        <img src="imgs/<?php echo $imagearr[2] ?>.png" style="width:100%; border-radius: 20px; border-color: <?php echo $imagecolorarr[2] ?>; border-style: groove;">

        <h1 class="hobby4"
          style="color: <?php echo $imagecolorarr[1] ?>; font-weight: bold; font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; text-align: center;">
          <?php echo $contentrarr[3] ?></h1>
        <img src="imgs/<?php echo $imagearr[3] ?>.png" style="width:100%; border-radius: 20px; border-color: <?php echo $imagecolorarr[2] ?>; border-style: groove;">
      </div>

    </div>

    <div class="w3-padding-10 w3-grayscale-min" style="text-align: center;">
      <p Class="hobbies"><?php echo $contentrarr[4] ?></p>
    </div>
